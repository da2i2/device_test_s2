...
size = os.path.getsize('device_list_s2.txt')



with open('device_list_s2.txt', 'r') as f:
...
myCmd = r'sudo lsusb > /home/pi/Desktop/device_test_s2/'+Device_name+'_USB.txt'
os.system(myCmd)
...
with open('device_list_s2.txt', 'a') as f:
    f.writelines('\n')
